<%-- 
    Document   : DataOwner
    Created on : 30 Apr, 2021, 4:03:27 PM
    Author     : KishanVenky
--%>
  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="DataOwner.jsp">Owner</a></li>
        <li><a href="User.jsp">User</a></li>
       <li><a href="Admin.jsp">Admin</a></li>
        <li class="last"><a href="CloudServer.jsp">Cloud</a></li>
      </ul>
    </div>
...
<div class="wrapper col3">
  <div id="intro">
    <div class="fl_left">
      ...
      <p>
will review and analyze different
existing DDoS detecting techniques against different
parameters, discusses their advantage and disadvantages,
and propose a hybrid statistical model that could
significantly mitigate these attacks and be a better
alternative solution for current detection problems.
      </p> 
